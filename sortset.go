...
func (this *Receiver) ZADD(key string, params ...interface{}) *Result {
	var ps []interface{}
	ps = append(ps, key)
	if len(params) > 0 {
		ps = append(ps, params...)
...
func (this *Receiver) ZCARD(key string) *Result {
	return this.Do("ZCARD", key)
}

//ZCOUNT 返回有序集 key 中， score 值在 min 和 max 之间(默认包括 score 值等于 min 或 max )的成员的数量。
func (this *Receiver) ZCOUNT(key string, min, max float64) *Result {
	return this.Do("ZCOUNT", key, min, max)
}

//ZINCRBY 为有序集 key 的成员 member 的 score 值加上增量 increment 。
func (this *Receiver) ZINCRBY(key string, increment float64, member string) *Result {
	return this.Do("ZINCRBY", key, increment, member)
}

//ZRANGE 返回有序集 key 中，指定区间内的成员。
func (this *Receiver) ZRANGE(key string, start, stop int, options ...string) *Result {
	var ps []interface{}
	ps = append(ps, key)
	ps = append(ps, start)
	ps = append(ps, stop)
...
func (this *Receiver) ZRANGEBYSCORE(key string, min, max float64, options ...interface{}) *Result {
	var ps []interface{}
	ps = append(ps, key)
	ps = append(ps, min)
	ps = append(ps, max)
...
func (this *Receiver) ZRANK(key, member string) *Result {
	return this.Do("ZRANK", key, member)
}

//ZREM 移除有序集 key 中的一个或多个成员，不存在的成员将被忽略。
func (this *Receiver) ZREM(key string, members ...string) *Result {
	var ps []interface{}
	ps = append(ps, key)
...
func (this *Receiver) ZREMRANGEBYRANK(key string, start, stop int) *Result {
	return this.Do("ZREMRANGEBYRANK", key, start, stop)
}

//ZREMRANGEBYSCORE 移除有序集 key 中，所有 score 值介于 min 和 max 之间(包括等于 min 或 max )的成员。
func (this *Receiver) ZREMRANGEBYSCORE(key string, min, max float64) *Result {
	return this.Do("ZREMRANGEBYSCORE", key, min, max)
}

//ZREVRANGE 返回有序集 key 中，指定区间内的成员。
func (this *Receiver) ZREVRANGE(key string, start, stop int, options ...interface{}) *Result {
	var ps []interface{}
	ps = append(ps, key)
	ps = append(ps, start)
	ps = append(ps, stop)
...
func (this *Receiver) ZREVRANGEBYSCORE(key string, max, min float64, options ...interface{}) *Result {
	var ps []interface{}
	ps = append(ps, key)
	ps = append(ps, max)
	ps = append(ps, min)
...
func (this *Receiver) ZREVRANK(key, member string) *Result {
	return this.Do("ZREVRANK", key, member)
}

//ZSCORE 返回有序集 key 中，成员 member 的 score 值。
func (this *Receiver) ZSCORE(key, member string) *Result {
	return this.Do("ZSCORE", key, member)
}

//ZUNIONSTORE 计算给定的一个或多个有序集的并集，其中给定 key 的数量必须以 numkeys 参数指定，并将该并集(结果集)储存到 destination 。
func (this *Receiver) ZUNIONSTORE(destination string, numKeys int, options ...interface{}) *Result {
	var ps []interface{}
...
func (this *Receiver) ZINTERSTORE(destination string, numKeys int, options ...interface{}) *Result {
	var ps []interface{}
	ps = append(ps, destination)
	ps = append(ps, numKeys)
	if len(options) > 0 {
...
func (this *Receiver) RANGEBYLEX(key string, min, max float64, options ...interface{}) *Result {
	var ps []interface{}
	ps = append(ps, key)
	ps = append(ps, min)
	ps = append(ps, max)
...
func (this *Receiver) ZLEXCOUNT(key string, min, max float64) *Result {
	return this.Do("ZLEXCOUNT", key, min, max)
}

//ZREMRANGEBYLEX 对于一个所有成员的分值都相同的有序集合键 key 来说， 这个命令会移除该集合中， 成员介于 min 和 max 范围内的所有元素。
func (this *Receiver) ZREMRANGEBYLEX(key string, min, max float64) *Result {
